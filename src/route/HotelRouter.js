...
router.post('/', authHotelManagerMiddleware, upload.single("hotelImage"), hotelController.createHotel)
router.put('/:id', authHotelManagerMiddleware, upload.single("hotelImage"), hotelController.updateHotel)

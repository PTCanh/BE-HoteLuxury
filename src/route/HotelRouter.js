...
router.post('/', authHotelManagerMiddleware, upload.array("hotelImage", 10), uploadMultipleToCloudinary, hotelController.createHotel)
router.put('/:id', authHotelManagerMiddleware, upload.array("hotelImage", 10), uploadMultipleToCloudinary, hotelController.updateHotel)
